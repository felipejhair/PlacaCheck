...
export const INVITACIONES: Record<string, XvInvitacion> = {
  ...
  arianne: {
    ...
    invitados: [
      ...
      { slug: "armando-soto",        nombre: "Armando Soto",                 limite: 3 },
      { slug: "mayra-jara-solis",    nombre: "Mayra Jara Solís",             limite: 2 },
      { slug: "dora-mendoza",        nombre: "Dora Mendoza Martínez",        limite: 2 },
      { slug: "mendez-martinez",     nombre: "Fam. Méndez Martínez",         limite: 2 },
      { slug: "griselda-otero",      nombre: "Griselda Otero",               limite: 2 },
      { slug: "russell-garcia",      nombre: "Fam. Russell García",          limite: 4 },
      { slug: "moncada-heredia",     nombre: "Fam. Moncada Heredia",         limite: 4 },
